...
class StepMysqlHelper implements Serializable {
    ...
    public static int getStepCount(String order, String filter) throws SQLException {
        ...
        sql.append(
                "SELECT COUNT(SchritteID) FROM schritte USE INDEX (priority_x_status) LEFT JOIN prozesse ON schritte.prozesseId = prozesse.ProzesseID LEFT JOIN batches ON prozesse.batchID = batches.id ");
    ...
    private static Step convert(ResultSet rs) throws SQLException {
        ...
        s.setRunInMessageQueue(rs.getBoolean("runInMessageQueue"));
    ...
    private static Object[] generateParameter(Step o, boolean includeID) {
        ...
        if (includeID) {
            Object[] param = { o.getId(), //SchritteID
                    ...
                    o.getHttpJsonBody(), o.isHttpCloseStep(), o.isHttpEscapeBodyJson(), o.isRunInMessageQueue() }; //httpStep
            return param;
        } else {
    ...
    private static String generateInsertQuery(boolean includeID) {
        ...
        answer += "Titel, Prioritaet, Reihenfolge, Bearbeitungsstatus, BearbeitungsZeitpunkt, BearbeitungsBeginn, BearbeitungsEnde, "
                ...
                + "httpStep, httpMethod, httpUrl, httpJsonBody, httpCloseStep, httpEscapeBodyJson, runInMessageQueue)" + " VALUES ";
        return answer;
    }
