...
public class FilesystemHelper {
	...
	/**
	 * Creates a directory with a name given. Under Linux a script is used to set
	 * the file system permissions accordingly. This cannot be done from within java
	 * code before version 1.7.
	 * 
	 * @param dirName Name of directory to create
	 * @throws InterruptedException If the thread running the script is interrupted
	 *                              by another thread while it is waiting, then the
	 *                              wait is ended and an InterruptedException is
	 *                              thrown.
