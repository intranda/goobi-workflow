...
/**
 * Mapping class for translating EAD terminology into UGH.
 * 
 * @author andrey
 */
public class MapperEAD {

    /** Loggers for this class. */
    private static final Logger loggerInfo = LoggerFactory.getLogger(MapperEAD.class);
    ...
    public static String getUGHTerm(String sourceTermn) {
        if (terms.isEmpty()) {
            loadTerms(ConfigHarvester.getInstance().getConfigFolder() + File.separator + "terms_ead.properties");
        }
