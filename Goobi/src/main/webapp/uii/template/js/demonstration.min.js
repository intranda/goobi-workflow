...
function randomFeed() {
    var $el = $("#randomFeed");
    var random = new Array('<span class="label label-default"><span class="fa fa-plus-square" /></span> <a href="#">John Doe</a> added a new photo', '<span class="label label-success"><span class="fa fa-user" /></span> New user registered', '<span class="label label-info"><span class="fa fa-shopping-cart" /></span> New order received', '<span class="label label-warning"><span class="fa fa-comment" /></span> <a href="#">John Doe</a> commented on <a href="#">News #123</a>'),
