		                ...
		                if (io.getImportReturnValue().equals(ImportReturnValue.ExportFinished)) {
		                    ...
		                    if (p == null) {
		                        ...
		                        gsr.setResultType(GoobiScriptResultType.ERROR);
		                    	 ...
		                    	 gsr.setResultMessage("Import successfully finished for id '" + gsr.getProcessTitle() + "'. Processname is " + io.getProcessTitle() + ".");
			                     gsr.setResultType(GoobiScriptResultType.OK);
			                 }
		                } else {
		                	String[] parameter = { io.getProcessTitle(), io.getErrorMessage() };
		                	gsr.setResultMessage("Import failed for id '" + gsr.getProcessTitle() + "'. " + Helper.getTranslation("importFailedError", parameter));
	                        gsr.setResultType(GoobiScriptResultType.ERROR);
	                    }
		            }
		            gsr.updateTimestamp();
