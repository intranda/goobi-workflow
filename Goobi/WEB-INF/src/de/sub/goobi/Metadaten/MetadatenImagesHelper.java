...
public class MetadatenImagesHelper {
     ...
     * 
     * @throws IOException
     * @throws ContentLibImageException 
     */
    public void scaleFile(String inFileName, String outFileName, int inSize, int intRotation) throws IOException,
            ContentLibImageException {
        ...
        if (ConfigMain.getParameter("ContentServerUrl") == null) {
            ...
            logger.trace("im");
            Dimension dim = new Dimension(tmpSize, tmpSize);
