...
public class Metadaten {
    ...
    private String MetadatenalsTree3Einlesen1() {
         ...
         */
        String label =
                this.logicalTopstruct.getType().getNameByLanguage((String) Helper.getManagedBeanValue("#{LoginForm.myBenutzer.metadatenSprache}"));
        if (label == null) {
    ...
    public String Paginierung() {
        Pagination p =
                new Pagination(this.alleSeitenAuswahl, this.alleSeitenNeu, this.paginierungAbSeiteOderMarkierung, this.paginierungArt,
    ...
    public void readAllTifFolders() throws IOException, InterruptedException, SwapException, DAOException {
        ...
        if (ConfigMain.getParameter("MetsEditorDefaultSuffix", null) != null) {
            ...
            for (String directory : this.allTifFolders) {
                if (directory.endsWith(suffix) && !directory.startsWith(myProzess.DIRECTORY_PREFIX)) {
    ...
    public String getCurrentRepresentativePage() {
        return this.currentRepresentativePage;
    }
