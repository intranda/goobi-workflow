...
//             this.loadFooter();      
             ...
             var osConfig = {
                     ...
                     tabIndex: this.config.global.tabIndex,
    ...
    imageView.Controls.Persistence = function(config, image) {
            ...
            if ( typeof ( Storage ) !== 'undefined' ) {
                ...
                if ( config.global.persistZoom || config.global.persistRotation ) {
                    try {
                        var location = JSON.parse( sessionStorage.wf_imageLocation );
                    }
                    catch ( err ) {
                        if ( _debug ) {
                    ...
                    this.saveLocation = function(event) {
                    	...
                    	sessionStorage.wf_imageLocation = JSON.stringify( loc );
                    	if ( _debug ) {
                    	    console.log( "storing zoom " + sessionStorage.wf_imageLocation );
                    	}
                    }
