             ...
             image.viewer.addHandler( 'open', function( event ) {
                 ...
                 if(Number.isNaN(event.eventSource.viewport.getHomeBounds().x)) {
                     ...
                     location.panTo = false;
                         ...
                         } else if(image.config.image.overlay && image.getSizes()) {
//                             console.log("fit image to available space", image.getSizes());
//                             var availableSpace = new OpenSeadragon.Rect(0,0, image.getSizes().innerCanvasSize.x,image.getSizes().innerCanvasSize.y);
//                             availableSpace.x += image.config.image.overlay.left;
//                             availableSpace.y += image.config.image.overlay.top;
//                             availableSpace.width -= (image.config.image.overlay.left + image.config.image.overlay.right);
//                             availableSpace.height -= (image.config.image.overlay.top + image.config.image.overlay.bottom);
//
//                             console.log("available canvas space ", availableSpace, " of ", image.getSizes().innerCanvasSize);
//                             var availableSpaceInOSCoords = image.viewer.viewport.viewerElementToViewportRectangle(availableSpace);
//                             console.log("availableSpace ", availableSpace, availableSpaceInOSCoords);
//                             var bounds = image.viewer.viewport.getBounds();
//                             console.log("bounds :", bounds);  
//                             image.viewer.viewport.fitBounds(new OpenSeadragon.Rect(-(availableSpaceInOSCoords.width-1)/2.0, -availableSpaceInOSCoords.y, bounds.width, bounds.height));
     ...
     function _calculateSizes(image) {
         ...
         if ( image.viewer != null && image.getSizes() ) {
            ...
            if(rotation%180 == 0){                
                ...
                margins.right = image.config.global.rightMargin * ratio;
                margins.left = 0;
                margins.top = image.config.global.topMargin;
                margins.bottom = (sizes.footerHeight + sizes.calculateExcessHeight());
            }
