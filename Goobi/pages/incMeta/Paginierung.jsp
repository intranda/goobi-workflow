...
<a4j:commandLink action="#{Metadaten.createPagination}" reRender="mygrid10,myMessages" value="#{msgs.paginierungEinlesen}" />

<%-- </h:form> --%>
<h:panelGrid id="mygrid10" columns="2" style="margin:0px;">

	<%-- ++++++++++++++++     Auswahl der Seiten      ++++++++++++++++ --%>
	<htm:table cellpadding="3" cellspacing="0" width="200px" rendered="#{Metadaten.alleSeiten !=null}" styleClass="eingabeBoxen" style="margin-top:20px">
		<htm:tr>
	...
	<htm:table rendered="#{Metadaten.alleSeiten ==null}" style="display:none" />
		...
		<htm:table cellpadding="3" cellspacing="0" id="PaginierungActionBox" rendered="#{Metadaten.alleSeiten !=null}" styleClass="eingabeBoxen"
			...
			<htm:tr>
				<htm:td styleClass="eingabeBoxen_row2">
					<h:selectOneMenu value="#{Metadaten.paginierungArt}" style="width: 250px" onchange="paginierungWertAnzeigen(this);">
					...
					<htm:br />
					<x:inputText id="paginierungWert" forceId="true" value="#{Metadaten.paginierungWert}" style="width: 250px;margin-top:15px;margin-bottom:5px" />
					<htm:br />
