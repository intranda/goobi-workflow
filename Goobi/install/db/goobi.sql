...
INSERT INTO `projekte` VALUES (1,'Beispielprojekt',1,3600000,'/opt/digiverso/viewer/hotfolder/','/opt/digiverso/viewer/hotfolder/','/opt/digiverso/viewer/success/','/opt/digiverso/viewer/error/',0,'Mets','Mets','Example Library','http://www.example.org/mylogo.png','http://www.example.org','mailto:digitisation@example.org','http://catalog.example.org/A?function=search&request=$(meta.CatalogIDDigital)','https://viewer.example.org/piresolver?id=$(meta.CatalogIDDigital)','http://catalog.example.org/A?function=search&request=$(meta.topstruct.CatalogIDDigital)','https://viewer.example.org/piresolver?id=$(meta.topstruct.CatalogIDDigital)','https://viewer.example.org/sourcefile?id=$(meta.CatalogIDDigital)','https://viewer.example.org/sourcefile?id=$(meta.topstruct.CatalogIDDigital)',NULL,NULL,'2015-01-01 00:00:00','2018-12-31 00:00:00',20000,100,0,NULL,NULL,NULL,NULL,NULL,1,NULL),(2,'SampleProject',1,3600000,'/opt/digiverso/viewer/hotfolder/','/opt/digiverso/viewer/hotfolder/','/opt/digiverso/viewer/success/','/opt/digiverso/viewer/error/',0,'Mets','Mets','Example Library','http://www.example.org/mylogo.png','http://www.example.org','mailto:digitisation@example.org','http://catalog.example.org/A?function=search&request=$(meta.CatalogIDDigital)','https://viewer.example.org/piresolver?id=$(meta.CatalogIDDigital)','http://catalog.example.org/A?function=search&request=$(meta.topstruct.CatalogIDDigital)','https://viewer.example.org/piresolver?id=$(meta.topstruct.CatalogIDDigital)','https://viewer.example.org/sourcefile?id=$(meta.topstruct.CatalogIDDigital)','https://viewer.example.org/sourcefile?id=$(meta.CatalogIDDigital)',NULL,NULL,'2015-01-01 00:00:00','2018-12-31 00:00:00',20000,100,0,NULL,NULL,NULL,NULL,NULL,1,NULL);
