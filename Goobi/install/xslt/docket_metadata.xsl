	...
	<xsl:template match="goobi:process">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:layout-master-set>
				<fo:simple-page-master master-name="A4" page-width="21cm" page-height="29.7cm" margin-left="1.5cm" margin-top="1.5cm" margin-right="1.5cm" margin-bottom="1.5cm">
					<fo:region-body/>
			...
			<fo:page-sequence master-reference="A4">
				<fo:flow flow-name="xsl-region-body" font-family="opensans, unicode">
					...
					<fo:block-container position="fixed" left="11.5cm" top="1cm">
						<fo:block>
								<fo:external-graphic src="url('{goobi:representative/@path}')" content-height="100mm"/>
						</fo:block>
					</fo:block-container>
					<!-- // thumbnail on right side -->

					<!-- general process data -->
					<fo:block-container position="fixed" left="1.2cm" top="1cm" width="9.5cm">
						...
						<fo:table line-height="13pt" font-size="9pt" margin-top="0.5cm" table-layout="fixed">
							...
							<fo:table-body>
								...
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block><xsl:value-of select="goobi:title"/></fo:block>
									</fo:table-cell>
								</fo:table-row>
								<!-- goobi identifier -->
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block><xsl:value-of select="@processID"/></fo:block>
									</fo:table-cell>
								</fo:table-row>
								<!-- project -->
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block><xsl:value-of select="goobi:project"/></fo:block>
									</fo:table-cell>
								</fo:table-row>
								<!-- ruleset -->
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block><xsl:value-of select="goobi:ruleset"/></fo:block>
									</fo:table-cell>
								</fo:table-row>
								<!-- creation data -->
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block><xsl:value-of select="goobi:creationDate"/></fo:block>
									</fo:table-cell>
								</fo:table-row>
								<!-- timestamp -->
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block><xsl:value-of select="goobi:pdfGenerationDate"/></fo:block>
									</fo:table-cell>
								</fo:table-row>
							</fo:table-body>
						</fo:table>
					...
					<!-- separator -->
					<fo:block border-top-width="1pt" border-top-style="solid" border-top-color="#cccccc" margin-top="10.5cm" margin-bottom="0.5cm"/>
