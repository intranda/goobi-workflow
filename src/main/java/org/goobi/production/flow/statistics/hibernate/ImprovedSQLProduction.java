...
class ImprovedSQLProduction extends SQLGenerator implements IProduction {
    ...
    ImprovedSQLProduction(Date timeFrom, Date timeTo, TimeUnit timeUnit, List<Integer> ids) {
    ...
    public String getSQL() {
        ...
        subQuery = "(SELECT prozesse.prozesseid AS singleProcess, " + "prozesse.sortHelperImages AS pages, "
                + getIntervallExpression(this.myTimeUnit, "BearbeitungsEnde") + " " + "AS intervall, BearbeitungsEnde AS timeLimiter "
