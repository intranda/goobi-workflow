...
public class GoobiScriptAddStep extends AbstractIGoobiScript implements IGoobiScript {
    ...
    public String getSampleCall() {
        ...
        addParameterToSampleCall(sb, NUMBER, "5", """
                This number defines where in the workflow this new step is ordered into. Numerical values or the keyword \"end\" are permitted
                 in order to insert the step at a specific position or at the end
                """);
        return sb.toString();
    }
