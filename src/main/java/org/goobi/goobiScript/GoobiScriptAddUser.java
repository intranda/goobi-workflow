...
public class GoobiScriptAddUser extends AbstractIGoobiScript implements IGoobiScript {
    ...
    public List<GoobiScriptResult> prepare(List<Integer> processes, String command, Map<String, String> parameters) {
        ...
        if (steptitle == null || "".equals(steptitle)) {
            Helper.setFehlerMeldung(missingParameter, FIELD_STEPTITLE);
            return new ArrayList<>();
        }
        String username = parameters.get(FIELD_USERNAME);
        if (username == null || "".equals(username)) {
            Helper.setFehlerMeldung(missingParameter, FIELD_USERNAME);
            return new ArrayList<>();
        }
    ...
    private User getUser(String userName) {
        try {
            ...
            if (treffer != null && !treffer.isEmpty()) {
                ...
                Helper.setFehlerMeldung("Unknown user: ", userName);
                return null;
            }
        } catch (DAOException e) {
            Helper.setFehlerMeldung("Error in GoobiScript.adduser", e);
