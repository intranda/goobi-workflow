...
/**
 * @deprecated Thumbnail hover-zoom moved to the thumbnailHoverZoom core
 * module (uii/template/js/modules/thumbnailHoverZoom.js)
 */
function drawOnCanvasMouseOut( event ) {
    console.warn( 'drawOnCanvasMouseOut() is deprecated; thumbnail hover-zoom now lives in the thumbnailHoverZoom core module. Remove this call.' );
}

/**
 * @deprecated See drawOnCanvasMouseOut() above.
 */
function getMousePos( canvas, event ) {
    console.warn( 'getMousePos() is deprecated; thumbnail hover-zoom now lives in the thumbnailHoverZoom core module. Remove this call.' );
}
...
function onMouseMove( event ) {
    console.warn( 'onMouseMove() is deprecated; thumbnail hover-zoom now lives in the thumbnailHoverZoom core module. Remove this call.' );
}
