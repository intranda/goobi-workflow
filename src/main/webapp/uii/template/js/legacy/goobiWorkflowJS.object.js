...
//                    }
		...
		startDrawArea(source, target) {
			if(_debug) console.log("start draw area", source, target);
            ...
            document.querySelectorAll(".above-overlay, .above-overlay canvas").forEach(e => this.setZIndex(e, 1000));
		...
		endDrawArea() {
            ...
            document.querySelectorAll(".above-overlay, .above-overlay canvas").forEach(e => this.resetZIndex(e));
		},
