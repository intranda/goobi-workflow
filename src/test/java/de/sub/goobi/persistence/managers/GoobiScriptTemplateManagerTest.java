...
public class GoobiScriptTemplateManagerTest extends AbstractTest {
    ...
    public void testConstructor() {
        try (MockedStatic<GoobiScriptTemplateMysqlHelper> mockedGoobiScriptTemplateMysqlHelper =
            ...
            mockedGoobiScriptTemplateMysqlHelper.when(() -> GoobiScriptTemplateMysqlHelper.getGoobiScriptTemplateCount(Mockito.anyString()))
                    .thenReturn(10);
            mockedGoobiScriptTemplateMysqlHelper
                    .when(() -> GoobiScriptTemplateMysqlHelper.getGoobiScriptTemplates(Mockito.anyString(), Mockito.anyString(), Mockito.anyInt(),
                            Mockito.anyInt()))
            ...
            mockedGoobiScriptTemplateMysqlHelper.when(() -> GoobiScriptTemplateMysqlHelper.getGoobiScriptTemplateById(Mockito.anyInt()))
                    .thenReturn(tmpl);
    ...
    public void testSaveGoobiScriptTemplate() throws Exception {
        try (MockedStatic<GoobiScriptTemplateMysqlHelper> mockedGoobiScriptTemplateMysqlHelper =
            ...
            GoobiScriptTemplate template = Mockito.mock(GoobiScriptTemplate.class);
